                            ...
                            <View className="flex-1 ml-3">
                                {(routeAdjusted || routeFallback) ? (
                                    <>
                                        ...
                                        <Text style={{ color: '#F87171', fontSize: 11, marginTop: 1 }} numberOfLines={showIncidents ? undefined : 1}>
                                    ...
                                    <>
                                        ...
                                        <Text style={{ color: '#FBBF24', fontSize: 11, marginTop: 1 }} numberOfLines={showIncidents ? undefined : 1}>
                                            Tap to view details
                                        </Text>
                                    </>
                                )}
                            </View>
                            <View className="items-center justify-center bg-black/20 rounded-full w-8 h-8 ml-2">
                        ...
                        <View>
                            ...
                            {route.directions.map((step, idx) => (
                                <TouchableOpacity 
                                    ...
                                    activeOpacity={0.9}
                                >
                                    <View style={{ opacity: navigating ? (idx === currentStepIndex ? 1 : 0.3) : (currentStepIndex === -1 ? 1 : currentStepIndex === idx ? 1 : 0.6) }}>
                            ...
                            {smartResult.found ? (
                                <>
                                    ...
                                    {smartResult.route.directions.map((step, i) => (
                                        <View key={i} style={{ opacity: navigating ? (i === currentStepIndex ? 1 : 0.3) : 1 }}>
